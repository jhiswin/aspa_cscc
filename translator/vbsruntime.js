//VBScript unassigned variables helper object
VBNoValueStatic = function(){};

VBNoValueStatic.prototype.equals = function(obj) {
	return	obj == "" || obj == 0 || obj == undefined ||
			obj == null || obj == false || obj.constructor == this.constructor;
};

VBNoValueStatic.prototype.valueOf = function(obj) {
	return 0;
};


VBNoValueStatic.prototype.toString = function() { return ""; };

VBNoValue = new VBNoValueStatic();
...
function gaussianRound(dVal, iDec) {
    ...
    var dFuzz=0.00001, // to deal with floating-point precision loss
    ...
    var dWorking = dVal * Math.pow ( 10.0, iDec + 1 ) -
